...
public final class PenchantDataGenerator {
    ...
    private static DataGenerator.PackGenerator builtinPack(DataGenerator generator, Identifier id) {
        // Prefer getPackGenerator so output lands at resourcepacks/<id> (what PenchantModules loads).
        // getBuiltinDatapack nests under data/<id>/datapacks/... which breaks pack discovery.
