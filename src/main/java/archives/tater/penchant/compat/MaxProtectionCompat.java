...
public final class MaxProtectionCompat {
    private static final Set<ResourceLocation> STACKABLE = Set.of(
            ResourceLocation.withDefaultNamespace("protection"),
            ResourceLocation.withDefaultNamespace("fire_protection"),
            ResourceLocation.withDefaultNamespace("blast_protection"),
            ResourceLocation.withDefaultNamespace("projectile_protection")
    );
    ...
    public static boolean isStackableProtection(Holder<Enchantment> enchantment) {
        return enchantment.unwrapKey()
                .map(key -> STACKABLE.contains(key.location()))
                .orElse(false);
    }
